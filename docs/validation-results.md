...
## September 7 — Git-event deployment acceptance

The user explicitly approved baseline/no-op and one new non-unique fixture-marker index. PR3 merged normally to `221799a1786b2ae6225be592a89aa0b02cf21983`; PR4 merged normally to `fc78e57a335426629a80ffdd74601c0c035db7c0`. Required exact-head Harness statuses passed before both merges. Protection remained enforced for administrators. Test PR2 stays closed and unmerged.

- [Manual baseline](https://app.harness.io/ng/account/7WPs0XUoT4CnMpX3j28V4g/all/orgs/default/projects/default_project/pipelines/mongodblabmergeddeploy/executions/fkzUquhkSR-4zPOoTnao3w/pipeline): SUCCESS: validate/update/repeat exit 0, three history entries and three documents preserved.
- [First protected-merge webhook](https://app.harness.io/ng/account/7WPs0XUoT4CnMpX3j28V4g/all/orgs/default/projects/default_project/pipelines/mongodblabmergeddeploy/executions/cCfVuIfSQnGVAoew6fOTiw/pipeline): SUCCESS: approved PR3 merge, unchanged baseline and repeat no-op.
- [Stale commit test](https://app.harness.io/ng/account/7WPs0XUoT4CnMpX3j28V4g/all/orgs/default/projects/default_project/pipelines/mongodblabmergeddeploy/executions/2G-UHiS1ReWrF4JDalny0g/pipeline): Expected FAILED: DEPLOYMENT_REJECTED before Atlas work.
- [Index merge webhook](https://app.harness.io/ng/account/7WPs0XUoT4CnMpX3j28V4g/all/orgs/default/projects/default_project/pipelines/mongodblabmergeddeploy/executions/ZJIXg-GeSCeqt9khOybrJQ/pipeline): SUCCESS: changeset 004 applied once; four history entries, three unchanged documents, new index verified; repeat ran zero changesets.

Final index-run fingerprint: `e8538b77ba8bfd74b02478d483636b82d230c0641ba4492b0656f40be3ae69a1`. No rollback, deletion, reset or history clearing occurred in this acceptance. The core three migration files remained byte-for-byte unchanged. Active-lock shutdown and fresh event-driven cold restart were separately verified; see [the automation guide](git-automation.md). A complete fresh-account rebuild and arbitrary-crash recovery remain untested.
